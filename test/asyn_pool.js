console.time("asyn_pool_all_the_work")
...
asyn.asyn_pool(times,i,function(err, result){
	console.log('fibo('+i+'):' + result)
	console.log('c++ thread asyn pool callback')
		assert.strictEqual(result, 102334155)
	if(!--job_times){
		console.timeEnd("asyn_pool_all_the_work")
		global.cb();
	}
})
